...
public class HorizontalMainActivity extends Activity implements View.OnClickListener {
    private Button mQueen;
    private Button mHidden;
    private HorizontalOuterLayout mOuterLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mOuterLayout = (HorizontalOuterLayout) findViewById(R.id.outer_layout);
